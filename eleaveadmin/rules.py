...
def checkM1247TotalHours(employee_type, start_date, end_date, leave_type_id):
	...
	# print("debug 1 : " + str(grand_total_hour))
	print("debug 1 day : " + str(total_day))
	print("debug 1 hour : " + str(total_hour))
...
def checkM1247TotalHours1(employee_type, d1, d2, leave_type_id):
    d1_temp = d1
    d2_temp = d2
    start_date = d1
    end_date = d2
    ...
    if total_hour == 24:
    	grand_total_hour = (grand_total_hour / 24) * 8

    print("debug 2: " + str(grand_total_hour))

    return grand_total_hour


def checkAllEmployeeType(employee_type, d1, d2, leave_type_id):
    d1_temp = d1
    d2_temp = d2
    start_date = d1
    end_date = d2
...
def checkM1247BusinessRules1(employee_type, start_date, end_date, leave_type_id):
	total_day = 0
	total_hour = 0
	result = 0
	day = 0
