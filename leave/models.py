...
class LeavePlan(models.Model):
    ...
    def EmployeeLeavePolicy(request):
        ...
        if UserName == 'superadmin':
            ...
            EmployeeLeavePolicyInstance = LeavePlan.objects.raw("select lp.emp_id as id, lp.lve_act, lp.lve_act_hr, lp.lve_miss, lp.lve_miss_hr, lt.lve_id as lve_type_id, lp.lve_code, lp.lve_plan, lp.lve_miss, lp.lve_miss_hr, lt.lve_th from leave_plan lp inner join leave_type lt on lp.lve_id=lt.lve_id where lp.emp_id=" + UserName + " and lp.lve_year=" + LeaveYear)
